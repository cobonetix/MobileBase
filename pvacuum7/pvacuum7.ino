...
char pumpAuto = 0;
char pumpOn = 0;
int pumpOnThreshold = 381;   // above this turn pump on  ~50 psi  - 150 psi sensor
int pumpOffThreshold = 674;  // below this turn pump off ~100 psi
...
void setup() {
  ...
  pinMode(AIR_VALVE, OUTPUT);  // air valve closed
  digitalWrite(AIR_VALVE, HIGH);
